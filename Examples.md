...
set(txt,'interpreter','latex');
ylabel('\fontname{Times New Roman}Diversity Value')
grid on
...
set(txt,'interpreter','latex');
ylabel('\fontname{Times New Roman}RMSDE Value')
grid on
```
![matrix of plots](examples/example5-1.jpg)
...
grid on
```
![matrix of plots](examples/example5-2.jpg)
